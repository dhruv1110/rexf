...
class TestExplorationEngine:
    ...
    def test_grid_search_strategy(self, unique_db_path, sample_math_experiment):
        ...
        try:
            ...
            expected = [
                {"x": 1.0, "y": 10.0}, {"x": 1.0, "y": 20.0},
                {"x": 2.0, "y": 10.0}, {"x": 2.0, "y": 20.0},
                {"x": 3.0, "y": 10.0}, {"x": 3.0, "y": 20.0},
            ]
...
class TestInsightsEngine:
    ...
    def test_basic_insights_generation(self, unique_db_path, sample_ml_experiment):
        ...
        try:
            ...
            run.single(sample_ml_experiment, learning_rate=0.001, batch_size=32, epochs=5)
            run.single(sample_ml_experiment, learning_rate=0.01, batch_size=64, epochs=5)
            run.single(sample_ml_experiment, learning_rate=0.1, batch_size=32, epochs=10)
    ...
    def test_parameter_impact_analysis(self, unique_db_path):
        ...
        try:
            ...
            experiments = [
                ...
                ExperimentRun(
                    run_id="impact-1", experiment_name="impact_test",
                    parameters={"learning_rate": 0.1}, metrics={"accuracy": 0.6},
                    status="completed", start_time=datetime.now()
                ),
                # Low learning rate = high accuracy
                ExperimentRun(
                    run_id="impact-2", experiment_name="impact_test",
                    parameters={"learning_rate": 0.001}, metrics={"accuracy": 0.9},
                    status="completed", start_time=datetime.now()
                ),
                # Medium learning rate = medium accuracy
                ExperimentRun(
                    run_id="impact-3", experiment_name="impact_test",
                    parameters={"learning_rate": 0.01}, metrics={"accuracy": 0.75},
                    status="completed", start_time=datetime.now()
                ),
            ]
...
class TestSuggestionEngine:
    ...
    def test_initial_experiments_suggestions(self, unique_db_path, sample_ml_experiment):
    ...
    def test_optimization_target_suggestions(self, unique_db_path, sample_ml_experiment):
...
class TestSmartQueryEngine:
    ...
    def test_query_execution(self, unique_db_path, sample_ml_experiment):
        ...
        try:
            ...
            run.single(sample_ml_experiment, learning_rate=0.001, epochs=5)  # Should have high accuracy
            run.single(sample_ml_experiment, learning_rate=0.1, epochs=5)    # Should have low accuracy
            run.single(sample_ml_experiment, learning_rate=0.01, epochs=10)  # Medium accuracy
...
class TestIntelligenceIntegration:
    ...
    def test_full_intelligence_workflow(self, unique_db_path, sample_optimization_experiment):
